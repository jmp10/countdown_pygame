...
class Tile:
    def __init__(self, char):
        self.char = char
        self.link = "C:\\Users\\mathw\\Pictures\\Countdown Tiles\\Countdown" + str(self.char) + ".png"
        self.image = pygame.image.load(self.link).convert()


class Light:
    def __init__(self, number):
        self.link = "C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Clock Lights\\ClockLight" +\
                    str(number) + ".png"
...
# fonts
futura = pygame.font.Font("C:\\Windows\\Fonts\\Futura Bold.otf", 55)
futura_names = pygame.font.Font("C:\\Windows\\Fonts\\Futura Bold.otf", 20)
futura_scores = pygame.font.Font("C:\\Windows\\Fonts\\Futura Bold.otf", 65)
futura_final_scores = pygame.font.Font("C:\\Windows\\Fonts\\Futura Bold.otf", 75)
futura_cond = pygame.font.Font("C:\\Windows\\Fonts\\Futura Condensed Bold.otf", 45)
digital = pygame.font.Font("C:\\Windows\\Fonts\\DSEG7Classic-BoldItalic.ttf", 100)
rodin = pygame.font.Font("C:\\Windows\\Fonts\\FOT-NewRodinProN-EB.otf", 130)

# images
bottom_overlay = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Bottom Overlay.png")\
    .convert()
background_l = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Studio - Bottom.png")\
    .convert()
background_n = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Studio - Bottom Numbers"
                                 ".png").convert()
background_empty = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Empty Background"
                                     ".png").convert()
clock_lines = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Clock Lines.png")\
    .convert_alpha()

clock_hand = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Clock Hand.png")\
    .convert_alpha()
...
# sounds
conundrum_buzzer = pygame.mixer.Sound("C:\\Users\\mathw\\Music\\Countdown Buzzer and Bell\\Countdown Buzzer.wav")
conundrum_bell = pygame.mixer.Sound("C:\\Users\\mathw\\Music\\Countdown Buzzer and Bell\\Countdown Bell.wav")
...
hidden = True
conundrum_overlay = pygame.image.load("C:\\Users\\mathw\\Pictures\\Countdown Presentation\\Countdown Conundrum Overlay"
                                      ".png").convert()
...
def reset_round():  # reset everything
    ...
    pygame.mixer.music.load("C:\\Users\\mathw\\Music\\Countdown Clock\\CountdownClock.mp3")
    angle = 0
    light_num = 0
...
def main_menu():
    ...
    pygame.mixer.music.load("C:\\Users\\mathw\\Music\\Spotify Local Files\\Countdown Theme Remix.mp3")
